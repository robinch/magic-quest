defmodule MagicQuestWeb.UserAuthTest do
  use MagicQuestWeb.ConnCase, async: true

  alias MagicQuest.Accounts
  alias MagicQuest.Accounts.Scope
  alias MagicQuestWeb.UserAuth

  import MagicQuest.AccountsFixtures

  @remember_me_cookie "_magic_quest_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MagicQuestWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
